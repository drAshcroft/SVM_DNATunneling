...
CREATE SCHEMA IF NOT EXISTS `Recognition_Tunneling_L` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE `Recognition_Tunneling_L` ;

-- -----------------------------------------------------
-- Table `Recognition_Tunneling_L`.`Experiments`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `Recognition_Tunneling_L`.`Experiments` (
...
-- -----------------------------------------------------
-- Table `Recognition_Tunneling_L`.`Analytes`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `Recognition_Tunneling_L`.`Analytes` (
...
-- -----------------------------------------------------
-- Table `Recognition_Tunneling_L`.`Folders`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `Recognition_Tunneling_L`.`Folders` (
...
-- -----------------------------------------------------
-- Table `Recognition_Tunneling_L`.`Files`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `Recognition_Tunneling_L`.`Files` (
  ...
  CONSTRAINT `fk_File_Folders1`
    ...
    REFERENCES `Recognition_Tunneling_L`.`Folders` (`Folder_Index` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `Recognition_Tunneling_L`.`Clusters`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `Recognition_Tunneling_L`.`Clusters` (
...
-- -----------------------------------------------------
-- Table `Recognition_Tunneling_L`.`Peaks`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `Recognition_Tunneling_L`.`Peaks` (
...
-- -----------------------------------------------------
-- Table `Recognition_Tunneling_L`.`Experiment_Analytes`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `Recognition_Tunneling_L`.`Experiment_Analytes` (
...
-- -----------------------------------------------------
-- Table `Recognition_Tunneling_L`.`AnalyteFolders`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `Recognition_Tunneling_L`.`AnalyteFolders` (
...
-- -----------------------------------------------------
-- Table `Recognition_Tunneling_L`.`SVM_Parameters`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `Recognition_Tunneling_L`.`SVM_Parameters` (
...
-- -----------------------------------------------------
-- Table `Recognition_Tunneling_L`.`SVM_Results`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `Recognition_Tunneling_L`.`SVM_Results` (
...
CREATE  TABLE IF NOT EXISTS `Recognition_Tunneling_L`.`SVM_Filtering` (
...
-- -----------------------------------------------------
-- Table `Recognition_Tunneling_L`.`SVM_Length_Results`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Recognition_Tunneling_L`.`SVM_Length_Results` (
...
-- -----------------------------------------------------
-- Table `Recognition_Tunneling_L`.`SVM_Analyte_Results`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Recognition_Tunneling_L`.`SVM_Analyte_Results` (
