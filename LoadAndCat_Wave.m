...
masterPaths{1} ='S:\Research\BrianAnalysis\Stacked Junctions\20140401_IBM_A_11_RIE_APGCmCAb';
masterPaths{2} ='S:\Research\BrianAnalysis\Stacked Junctions\20140402_IBM_A_11_RIE_AGCTmC';
masterPaths{3} ='S:\Research\BrianAnalysis\Stacked Junctions\20140303_IBM_A_17_RIE_ACTG\For Brian analysis';
masterPaths{4} ='S:\Research\BrianAnalysis\Stacked Junctions\20140414_IBM_A_13_RIE_AGC_1nM\Files for Brian';

for mI=2:2%length(masterPaths)
...
%wShortData2=wShortData(:,1:1000);
[lmaxima,indices] = localmax(wShortData,[],false);
[iRow,iCol] = find(lmaxima);

imagesc(abs(wShortData)); axis xy;drawnow;
                ...
                save([p '\'  fn '_Wave1.mat'],'fn','shortData','wShortData','iRow','iCol','freq','bottom','widths');
